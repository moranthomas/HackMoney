...
import Logo from '../../assets/svg/ConvexityLogoLight.png'
import LogoDark from '../../assets/svg/ConvexityLogoDark.png'
  ...
  return (
    <HeaderFrame showBackground={scrollY > 45}>
      ...
      <HeaderRow>
        <Title href=".">
          <UniIcon>
            <img width={'156px'} src={darkMode ? LogoDark : Logo} alt="logo" />
          </UniIcon>
        </Title>
      </HeaderRow>
      <HeaderLinks>
